    ...
    return (
        <div className="w-full max-w-[1920px] mx-auto pt-32 px-6 pb-24">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-32 mb-24 p-8 md:p-12 bg-[#fafaf9] dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-900 transition-colors duration-300">
                    <div className="flex items-end gap-6 mb-16 border-b border-zinc-200 dark:border-zinc-800 pb-8">
                ...
                <div className="mt-24 p-12 bg-[#fafaf9] dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-center transition-colors">
